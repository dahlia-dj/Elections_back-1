    ...
    @endif
        ...
        <div class="row">
            ...
            <div>
                ...
                <input type="radio" class="form-check-input" id="radio1" name="radiobouton" value="M">
                <label class="custom-control-label" for="radio1">M</label> 
                </div>
                <div class="form-check form-check-inline">    
                <input type="radio" class="form-check-input" id="radio2" name="radiobouton" value="F">
        ...
        <div class="row">
            ...
            <div>
                <div class="form-check form-check-inline">
                <input type="radio" class="form-check-input" id="radio1" name="radiobouton2" value="E">
                <label class="custom-control-label" for="radio1">Electeur</label> 
                </div>
                <div class="form-check form-check-inline">    
                <input type="radio" class="form-check-input" id="radio2" name="radiobouton2" value="C">
      ...
      <div class="row">
        ...
        <div>
            <div class="form-check form-check-inline">
            <input type="radio" class="form-check-input" id="radio1" name="radiobouton3" value="1">
            <label class="custom-control-label" for="radio1">Voter</label> 
            </div>
            <div class="form-check form-check-inline">    
            <input type="radio" class="form-check-input" id="radio1" name="radiobouton3" value="0">
